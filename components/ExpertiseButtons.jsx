  ...
  return (
    <div className={`grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 ${className} expertise-buttons`}>
      <button className="flex items-center bg-slate-200 hover:bg-slate-300 text-white font-medium py-2 px-4 rounded-full">
        ...
        <span className="text-[#263C48]">Front End</span>
      </button>
      ...
      <button className="flex items-center bg-slate-200 hover:bg-slate-300 text-white font-medium py-2 px-4 rounded-full">
        ...
        <span className="text-[#263C48]">Back End</span>
      </button>
      ...
      <button className="flex items-center bg-slate-200 hover:bg-slate-300 text-white font-medium py-2 px-4 rounded-full">
        ...
        <span className="text-[#263C48]">DevOps</span>
      </button>
      ...
      <button className="flex items-center bg-slate-200 hover:bg-slate-300 text-white font-medium py-2 px-4 rounded-full">
        ...
        <span className="text-[#263C48]">SEO</span>
      </button>
    </div>
  );
};
